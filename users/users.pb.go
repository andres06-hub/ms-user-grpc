...
func (x *CreateUserRequest) GetIdentity() string {
	if x != nil {
		return x.Identity
	}
	return ""
...
func (x *Response) GetSuccess() string {
	if x != nil {
		return x.Success
	}
	return ""
...
var file_users_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x73, 0x22, 0x59, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73,
	...
	0x69, 0x64, 0x22, 0x5f, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x18,
	...
	0x32, 0x0b, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64,
	0x61, 0x74, 0x61, 0x22, 0x1a, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x12, 0x0a, 0x04, 0x6e,
	0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x32,
	0x75, 0x0a, 0x05, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x37, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x61,
	...
	0x65, 0x12, 0x33, 0x0a, 0x08, 0x66, 0x69, 0x6e, 0x64, 0x55, 0x73, 0x65, 0x72, 0x12, 0x16, 0x2e,
	0x75, 0x73, 0x65, 0x72, 0x73, 0x2e, 0x46, 0x69, 0x6e, 0x64, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0f, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2e, 0x52, 0x65,
...
var file_users_proto_goTypes = []interface{}{
	...
	(*FindUserRequest)(nil),   // 1: users.FindUserRequest
	(*Response)(nil),          // 2: users.Response
	(*Data)(nil),              // 3: users.Data
}
var file_users_proto_depIdxs = []int32{
	3, // 0: users.Response.data:type_name -> users.Data
	0, // 1: users.Users.createUser:input_type -> users.CreateUserRequest
	1, // 2: users.Users.findUser:input_type -> users.FindUserRequest
	2, // 3: users.Users.createUser:output_type -> users.Response
	2, // 4: users.Users.findUser:output_type -> users.Response
